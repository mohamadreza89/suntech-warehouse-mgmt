 ...
 */
var kamaDatepicker = function (elementID,but, opt) {
    ...
    options.highlightSelectedDay = options.highlightSelectedDay !== undefined ? options.highlightSelectedDay : true;
    options.sync = options.sync !== undefined ? options.sync : true;
    options.gotoToday = options.gotoToday !== undefined ? options.gotoToday : false;

    // create DOM
    var inputElement = $("#" + elementID);
    //var butElement=$("#" + elementID);
